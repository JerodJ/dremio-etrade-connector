...
@SourceType(value = "EtradeARP", label = "Etrade",uiConfig = "etrade-layout.json")
public class EtradeConf extends AbstractArpConf<EtradeConf> {
  private static final String ARP_FILENAME = "arp/implementation/etrade-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.etrade.EtradeDriver";
